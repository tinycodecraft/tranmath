      ...
      <Container className='flex flex-row h-screenHeightNoheadFoot pb-3'>
        <div className='flex w-[320px] min-w-[320px] flex-col border-r border-black py-12 pr-4'>
          ...
          <div className='mt-auto'>
            ...
            <p className='mt-auto'>
              The Foldy chair is our latest master piece combining all assets nature brings. Bamboo
              for keeping your cheeks happy, some other wood for the durability and a nice towel for
              the hot days.
            </p>
          </div>
        </div>
        <div className='[&_img]:mr-4 flex overflow-x-auto'>
          <motion.img
